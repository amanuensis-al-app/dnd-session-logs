 ...
 * DMG table: a scroll's rarity is set by its spell's level, not chosen freely). An
 * unlisted spell just leaves whatever rarity the source already had (see
 * `resolveSpellScroll`).
 *
 * Sourced from 5e.tools (https://5e.tools/spells.html) 2026-07-18: every spell across
 * all its sourcebooks (PHB/XPHB, XGE, TCE, EGW, FTD, and more), deduped by name —
 * 557 entries, zero level conflicts between sources. A reprinted spell (e.g. 2014 PHB
 * vs 2024 XPHB) keeps the same level either way, so this list doesn't distinguish
 * editions.
 */
...
export const SPELL_LIST: SpellDefinition[] = [
  ...
  { name: 'Frost Fingers', level: 1 },
  { name: 'Gift of Alacrity', level: 1 },
  ...
  { name: 'Jim\'s Magic Missile', level: 1 },
  { name: 'Jump', level: 1 },
  { name: 'Longstrider', level: 1 },
  { name: 'Mage Armor', level: 1 },
  { name: 'Magic Missile', level: 1 },
  { name: 'Magnify Gravity', level: 1 },
  ...
  { name: 'Spellfire Flare', level: 1 },
  { name: 'Tasha\'s Caustic Brew', level: 1 },
  ...
  { name: 'Flock of Familiars', level: 2 },
  { name: 'Fortune\'s Favor', level: 2 },
  { name: 'Gentle Repose', level: 2 },
  { name: 'Gift of Gab', level: 2 },
  { name: 'Gust of Wind', level: 2 },
  { name: 'Healing Spirit', level: 2 },
  { name: 'Heat Metal', level: 2 },
  { name: 'Hold Person', level: 2 },
  { name: 'Homunculus Servant', level: 2 },
  { name: 'Immovable Object', level: 2 },
  { name: 'Invisibility', level: 2 },
  { name: 'Jim\'s Glowing Coin', level: 2 },
  { name: 'Kinetic Jaunt', level: 2 },
  { name: 'Knock', level: 2 },
  ...
  { name: 'Nathair\'s Mischief', level: 2 },
  ...
  { name: 'Rime\'s Binding Ice', level: 2 },
  ...
  { name: 'Raulothim\'s Psychic Lance', level: 4 },
  { name: 'Shadow of Moil', level: 4 },
  { name: 'Sickening Radiance', level: 4 },
  { name: 'Spellfire Storm', level: 4 },
  { name: 'Spirit of Death', level: 4 },
  ...
  { name: 'Alustriel\'s Mooncloak', level: 5 },
  ...
  { name: 'Create Spelljamming Helm', level: 5 },
  ...
  { name: 'Jallarzi\'s Storm of Radiance', level: 5 },
  ...
  { name: 'Yolande\'s Regal Presence', level: 5 },
  ...
  { name: 'Tasha\'s Bubbling Cauldron', level: 6 },
  { name: 'Tasha\'s Otherworldly Guise', level: 6 },
  { name: 'Tenser\'s Transformation', level: 6 },
  ...
  { name: 'Befuddlement', level: 8 },
  { name: 'Clone', level: 8 },
  { name: 'Control Weather', level: 8 },
  { name: 'Dark Star', level: 8 },
